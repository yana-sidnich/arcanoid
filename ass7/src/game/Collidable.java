...
/**
 * An Interface to represent a collidable object. A collidable is an object that
 * can be collided with, and change the velocity of the colliding object (a Ball
...
public interface Collidable {
     ...
     * @param game GameLevel to add the collidable to.
     */
