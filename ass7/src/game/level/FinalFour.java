...
public class FinalFour implements LevelInformation {
    ...
    /**
     * Constructor of the FinalFour class.
     */
    public FinalFour() {
    ...
    private void initializeBlocks() {
        ...
        int height = GameLevel.GAME_GUI_HEIGHT / 4;
        ...
        // each color is for a different lines
        Color[] colors = {Color.gray, Color.red, Color.yellow, Color.green,
                          Color.white, Color.pink, new Color(51, 204, 255)};

        int startX = GameLevel.SCREEN_BLOCK_THICKNESS;
        // draw the block lines - 15 blocks at a line.
